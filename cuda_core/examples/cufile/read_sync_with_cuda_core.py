...
def main():
    ...
    # Buffer is automatically managed - no manual free needed!
    ...
    # Step 7: Read file into GPU buffer using Buffer object
    ...
    # Cleanup: Close handles BEFORE closing driver
    # Note: gpu_buffer is automatically freed when it goes out of scope!
    buf_handle.close()
    file_handle.close()
    cufile.driver_close()
